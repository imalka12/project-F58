...
<div class="container p-5">
    ...
    <div class="col-lg-12 mt-5">
        ...
        <div class="card pt-5">
            <div class="card-body">
                <h2 class="card-text text-center text-uppercase mb-4">Pay to Promote your advertisement</h2>
                <div class="row">
                    <div class="col-lg-6 py-5 pt-0 text-center">
                        ...
                        <div class="text-primary mt-5">
                            <h6>Pay Amount</h6>
                            <h3>LKR {{ number_format(config('system.payments.advertisement_promote'), 2) }}</h3>
                        </div>
                    </div>
                    <div class="col-lg-6 py-3">
                        ...
                        <form id="payment_form" action="{{ route('advertisement.promote.process', $advertisement->id) }}" method="post" data-has-token="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}">
                            @csrf
